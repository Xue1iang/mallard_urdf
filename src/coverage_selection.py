...
class areaMarker(object):
    ...
    def __init__(self, globalFrame = "map"):
        ...
        firstCornerPose.position.x = -1 #original
        # firstCornerPose.position.x = 0
        # firstCornerPose.position.y = -1 #original
        ...
        # secondCornerPose.position.x = 1.0 #original
        secondCornerPose.position.x = 2.5
        secondCornerPose.position.y = 1.0 #original
        # secondCornerPose.position.y = 0.0
