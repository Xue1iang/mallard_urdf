...
def slam_callback(data, paramf):
    ...
    name = "x"
    xdes, xveldes,x_ades = kglocal.velramp(t_now, xvelmax, x0, x_goal, param['t_ramp'],name)
    name = "y"
    ydes, yveldes,y_ades = kglocal.velramp(t_now, yvelmax, y0, y_goal, param['t_ramp'],name)
